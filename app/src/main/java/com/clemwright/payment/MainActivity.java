...
package com.clemwright.payment;
...
import com.clemwright.payment.util.IabBroadcastReceiver;
import com.clemwright.payment.util.IabBroadcastReceiver.IabBroadcastListener;
import com.clemwright.payment.util.IabHelper;
import com.clemwright.payment.util.IabHelper.IabAsyncInProgressException;
import com.clemwright.payment.util.IabResult;
import com.clemwright.payment.util.Inventory;
import com.clemwright.payment.util.Purchase;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * use bit manipulation (for clemwright, XOR with some other string) to hide
         * the actual key.  The key itself is not secret information, but we don't
         * want to make it easy for an attacker to replace the public key with one
         * of their own and then fake messages from the server.
         */
        String base64EncodedPublicKey = "";
...
//        if (getPackageName().startsWith("com.clemwright")) {
